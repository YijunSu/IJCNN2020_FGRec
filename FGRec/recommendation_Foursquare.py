...
def main():
    ...
    result_p = open("./result/result_top_" + "Pre" + "_FGRec_F.txt", 'w')
    result_r = open("./result/result_top_" + "Rec" + "_FGRec_F.txt", 'w')
    result_m = open("./result/result_top_" + "MAP" + "_FGRec_F.txt", 'w')
    result_n = open("./result/result_top_" + "NDCG" + "_FGRec_F.txt", 'w')
    ...
    for cnt, uid in enumerate(all_uids):
        if uid in ground_truth:
            JPF_scores = [JPF.predict(uid, lid, True, POI_cate_matrix, 2)
...
if __name__ == '__main__':
    ...
    category_file = data_dir + "Foursquare_user_category.txt"
    poi_file = data_dir + "Foursquare_poi_coos.txt"
    user_social_friends_file = data_dir + "Foursquare_social_friends.txt"
    user_neighbor_friends_file = data_dir + "Foursquare_neighbor_friends.txt"
    user_vector_file = data_dir + "Foursquare_user_vector.txt"
    user_features_file = data_dir + "Foursquare_user_features.txt"
    user_home_file = data_dir + "Foursquare_user_home.txt"
    POI_category_file = data_dir + "Foursquare_poi_categories.txt"
    ...
    JPF = JointPoissonFactorModel(K=40, alpha=40.0, beta=0.35)
